...
APP_ARCHIVE="/home/ubuntu/upload/lab-creator-enhanced-v2-FINAL.tar.gz"
APP_DIR="/home/ubuntu/lab-creator-enhanced-v2-FINAL"
...
tar -xzf "$APP_ARCHIVE" -C "$APP_DIR" --strip-components=1 || error_exit "Échec de l'extraction de l'archive."
